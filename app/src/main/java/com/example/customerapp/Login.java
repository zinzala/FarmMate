    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String url = "http://192.168.63.122:8018/Market_place/harshadApp/public/api/users/login";
                            ...
                            public void onResponse(String response) {
                                ...
                                try {
                                    ...
                                    if (status.equals("success")) {
                                        ...
                                        myEdit.apply();
                                        Intent intent = new Intent(getApplicationContext(), FarmerActivity.class); // change MainActivity.class to FarmerActivity.class
                                        startActivity(intent);
                                        finish();
                                    } else {
